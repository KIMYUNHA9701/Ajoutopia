...
public class StudyBoardActivity extends AppCompatActivity{
    ...
    private StudyPostAdapter mAdapter;
    private List<StudyWriteInfo> mDatas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Study 게시판");
        mPostRecyclerView = findViewById(R.id.studyBoardRv);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.main_post_edit:
                    myStartActivity(StudyPostActivity.class);
                    break;
                case R.id.homeBtn:
